...
{
    public interface IQuerytor<TSource> : IUnitWork
    {
        /// <summary>
        ...
        /// <returns></returns>
        IQuerytor<TSource> Where(Expression<Func<TSource, bool>> predicate);
        ...
        /// <returns></returns>
        IQuerytor<TSource> OrderBy<TKey>(Expression<Func<TSource, TKey>> keySelector);
        ...
        /// <param name="keySelector">A function to extract a key from an element.</param>
        /// <returns></returns>
        IQuerytor<TSource> OrderByDescending<TKey>(Expression<Func<TSource, TKey>> keySelector);
        ...
        /// <returns></returns>
        IQuerytor<TSource> GroupBy<TKey>(Expression<Func<TSource, TKey>> keySelector);
        ...
        /// <returns></returns>
        IQuerytor<TSource> Skip(int count);
        ...
        /// <returns></returns>
        IQuerytor<TSource> Take(int count);
